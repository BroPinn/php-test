...
<script src="https://cdn.jsdelivr.net/gh/BroPinn/cdn-file@main/admin/js/core/bootstrap.min.js"></script>
    ...
    <!-- jQuery Vector Maps -->
    <script src="https://cdn.jsdelivr.net/gh/BroPinn/cdn-file@main/admin/js/plugin/jqvmap/jquery.vmap.min.js"></script>
    <script src="https://cdn.jsdelivr.net/gh/BroPinn/cdn-file@main/admin/js/plugin/jqvmap/maps/jquery.vmap.world.js"></script>

        ...
        .then(data => {
            if (data.success) {
                ...
                if (product.image_path) {
                    document.getElementById("preview").src = "/uploads/" + product.image_path;
                    document.getElementById("imagePreview").style.display = "block";
                }
                
                document.getElementById("productForm").action = `/admin/products/update?id=${id}`;
...
function deleteProduct(id) {
    if (confirm("Are you sure you want to delete this product?")) {
        ...
        form.method = "POST";
        form.action = `/admin/products/delete?id=${id}`;

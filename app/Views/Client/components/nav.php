...
<div class="wrap-menu-desktop how-shadow1">
    <nav class="limiter-menu-desktop container">
        ...
        <div class="wrap-icon-header flex-w flex-r-m">
            ...
            <a href="/wishlist" class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti" data-notify="0">
...
<div class="wrap-header-mobile">
    ...
    <div class="logo-mobile">
        <a href="/"><img src="https://cdn.jsdelivr.net/gh/BroPinn/cdn-file@main/client/images/icons/logo-01.png" alt="OneStore Logo"></a>
    </div>
    ...
    <div class="wrap-icon-header flex-w flex-r-m m-r-15">
        ...
        <a href="/wishlist" class="dis-block icon-header-item cl2 hov-cl1 trans-04 p-r-11 p-l-10 icon-header-noti" data-notify="0">
            <i class="zmdi zmdi-favorite-outline"></i>
        </a>
    </div>
...
<div class="menu-mobile">
    <ul class="topbar-mobile">
        ...
        <li>
            <div class="right-top-bar flex-w h-full">
                ...
                <?php if ($user): ?>
                    <a href="/account" class="flex-c-m p-lr-10 trans-04"><?= Helper::sanitize($user['name']) ?></a>
                    <a href="/logout" class="flex-c-m p-lr-10 trans-04">Logout</a>
                <?php else: ?>
                    <a href="/login" class="flex-c-m p-lr-10 trans-04">Login</a>
                    <a href="/register" class="flex-c-m p-lr-10 trans-04">Register</a>
                <?php endif; ?>
    ...
    <ul class="main-menu-m">
        ...
        <li class="<?= Helper::urlIs('checkout') ? 'active-menu' : '' ?>">
            <a href="/checkout" class="label1 rs1" data-label1="hot">Features</a>
        </li>
        <li class="<?= Helper::urlIs('blog') ? 'active-menu' : '' ?>">
            <a href="/blog">Blog</a>
        </li>

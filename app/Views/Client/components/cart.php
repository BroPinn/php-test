                ...
                <div class="w-full">
                    ...
                    <div class="header-cart-buttons flex-w w-full">
                        <a href="<?= Helper::url('/checkout') ?>"
                            class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-lr-auto">
                            Check Out
                        </a>
                    </div>
                </div>
        ...
        updateCartDisplay(items, totals) {
            ...
            <li class="header-cart-item flex-w flex-t m-b-12" data-product-id="${item.product_id || item.productID}">
                <div class="header-cart-item-img">
                    <img src="${window.OneStoreClient.uploadUrl}${item.image_path || item.image || 'placeholder.jpg'}" alt="${item.name || item.productName}" style="width: 60px; height: 60px; object-fit: cover;">
                </div>

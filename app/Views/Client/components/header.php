...
<header>
        ...
        <div class="top-bar">
            <div class="content-topbar flex-sb-m h-full container">
                ...
                <div class="right-top-bar flex-w h-full">
                    ...
                    <a href="/language" class="flex-c-m trans-04 p-lr-25">
                        EN
                    </a>

                    <a href="/currency" class="flex-c-m trans-04 p-lr-25">
                        USD
                    </a>
                </div>
            </div>
        ...
        <div class="wrap-menu-desktop">
            <nav class="limiter-menu-desktop container">
                ...
                <div class="wrap-icon-header flex-w flex-r-m">
                    ...
                    <a href="/wishlist" class="dis-block icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti" data-notify="<?= $wishlist_count ?? 0 ?>">
    ...
    <div class="wrap-header-mobile">
        ...
        <div class="logo-mobile">
            <a href="/"><img src="<?= Helper::asset('images/icons/logo-01.png') ?>" alt="IMG-LOGO"></a>
        </div>
        ...
        <div class="wrap-icon-header flex-w flex-r-m m-r-15">
            ...
            <a href="/wishlist" class="dis-block icon-header-item cl2 hov-cl1 trans-04 p-r-11 p-l-10 icon-header-noti" data-notify="<?= $wishlist_count ?? 0 ?>">
                <i class="zmdi zmdi-favorite-outline"></i>
            </a>
        </div>
    ...
    <div class="menu-mobile">
        <ul class="topbar-mobile">
            ...
            <li>
                <div class="right-top-bar flex-w h-full">
                    <a href="/help" class="flex-c-m p-lr-10 trans-04">
                        Help & FAQs
                    </a>
                    ...
                    <a href="/language" class="flex-c-m p-lr-10 trans-04">
                        EN
                    </a>

                    <a href="/currency" class="flex-c-m p-lr-10 trans-04">
                        USD
                    </a>
                </div>
            </li>

...
<div class="bg0 p-t-75 p-b-85">
    <div class="container">
        <!-- Empty Cart State -->
        <div id="empty-cart-state" class="txt-center p-t-50 p-b-50"
                ...
                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <p class="stext-113 cl6">
                                                You're checking out as a guest. To save your information and view order
                                                history, consider creating an account.
                                            </p>
                                        </div>
                                        <div class="col-md-4 text-right">
                                            <a href="<?= Helper::url('/login') ?>"
                                                class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-b-10">
                                                <i class="fa fa-sign-in m-r-5"></i>
                                                Login
                                            </a>
                                            <a href="<?= Helper::url('/register') ?>"
                                                class="flex-c-m stext-101 cl2 size-107 bor2 hov-btn1 p-lr-15 trans-04">
                            ...
                            <div class="bor10 p-lr-40 p-t-30 p-b-40 m-t-40">
                                ...
                                <div class="row p-b-25">
                                    <div class="col-md-6 p-b-15">
                                        ...
                                        <input class="stext-104 cl2 plh4 size-116 bor13 p-lr-20 p-tb-15" type="text"
                                            name="billing_first_name" placeholder="Enter your first name"
                                            value="<?= htmlspecialchars($customer['firstName'] ?? '') ?>" required>
                                    </div>
                                    <div class="col-md-6 p-b-15">
                                        <label class="stext-102 cl3 p-b-5">Last Name *</label>
                                        <input class="stext-104 cl2 plh4 size-116 bor13 p-lr-20 p-tb-15" type="text"
                                            name="billing_last_name" placeholder="Enter your last name"
                                ...
                                <div class="row p-b-25">
                                    <div class="col-md-6 p-b-15">
                                        ...
                                        <input class="stext-104 cl2 plh4 size-116 bor13 p-lr-20 p-tb-15" type="email"
                                            name="billing_email" placeholder="Enter your email address"
                                            value="<?= htmlspecialchars($customer['email'] ?? '') ?>" required>
                                    </div>
                                    <div class="col-md-6 p-b-15">
                                        <label class="stext-102 cl3 p-b-5">Phone Number *</label>
                                        <input class="stext-104 cl2 plh4 size-116 bor13 p-lr-20 p-tb-15" type="tel"
                                            name="billing_phone" placeholder="Enter your phone number"
                                ...
                                <div class="row p-b-25">
                                    <div class="col-12 p-b-15">
                                        ...
                                        <input class="stext-104 cl2 plh4 size-116 bor13 p-lr-20 p-tb-15" type="text"
                                            name="billing_address1" placeholder="Enter your street address"
                                ...
                                <div class="row p-b-25">
                                    ...
                                    <div class="col-md-4 p-b-15">
                                        ...
                                        <input class="stext-104 cl2 plh4 size-116 bor13 p-lr-20 p-tb-15" type="text"
                                            name="billing_state" placeholder="Enter your state"
                                            value="<?= htmlspecialchars($customer['addresses'][0]['state'] ?? '') ?>"
                                            required>
                                    </div>
                                    <div class="col-md-4 p-b-15">
                                        <label class="stext-102 cl3 p-b-5">ZIP Code *</label>
                                        <input class="stext-104 cl2 plh4 size-116 bor13 p-lr-20 p-tb-15" type="text"
                                            name="billing_postal_code" placeholder="Enter your ZIP code"
                                            value="<?= htmlspecialchars($customer['addresses'][0]['postal_code'] ?? '') ?>"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="row p-b-25">
                                    <div class="col-md-6 p-b-15">
                                        ...
                                        <select class="stext-104 cl2 plh4 size-116 bor13 p-lr-20" name="billing_country"
                                            required>
                                        ...
                                        <div class="col-md-6 p-b-15">
                                            <div class="bg-light p-lr-15 p-tb-10 bor10" style="border-radius: 8px;">
                                                ...
                                                <p class="stext-115 cl6">
                                                    <small>Your information has been automatically filled. You can edit it
                                                        if needed.</small>
                                                </p>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <textarea class="stext-104 cl2 plh4 size-120 bor13 p-lr-20 m-tb-5"
                                            name="order_notes" rows="4"
                    ...
                    <div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
                        <div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
                            ...
                            <div class="p-b-30">
                                ...
                                <div class="flex-w flex-sb-m bor12 p-t-15 p-b-15">
                                    <label class="flex-w flex-m pointer p-b-10">
                                        <input type="radio" name="payment_method" value="paypal" checked class="m-r-10"
                                            id="paypal-radio">
                                        <span class="stext-110 cl2">
                                ...
                                <div class="flex-w flex-sb-m bor12 p-t-15 p-b-15">
                                    <label class="flex-w flex-m pointer p-b-10">
                                        <input type="radio" name="payment_method" value="cod" class="m-r-10"
                                            id="cod-radio">
                                        <span class="stext-110 cl2">
                            ...
                            <button type="submit"
                                class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer"
                                id="place-order-btn" style="display: none;">
                                Place Order
                            </button>
                        </div>
                    </div>
...
<script>
    ...
    window.OneStoreClient = window.OneStoreClient || {
        baseUrl: '<?= Helper::url() ?>',
        uploadUrl: '<?= (basename($_SERVER["DOCUMENT_ROOT"] ?? "") === "public") ? "/uploads/" : "/public/uploads/" ?>',
            ...
            <tr class="table_row" data-product-id="${item.productID}">
                <td class="column-1">
                    <div class="how-itemcart1">
                        <img src="${window.OneStoreClient.uploadUrl}${item.image_path || 'placeholder.jpg'}" alt="${item.name}">
                    </div>
                </td>
